...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_AngularAcceleration_3;

public class VE_AngularAcceleration_3 extends ValidationError<AngularAcceleration> {
  @Override
  protected List<AngularAcceleration> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_AngularAcceleration_3, context.owl.prefixManager);
