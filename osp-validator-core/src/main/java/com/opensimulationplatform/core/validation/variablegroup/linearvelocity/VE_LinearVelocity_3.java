...
public class VE_LinearVelocity_3 extends ValidationError<LinearVelocity> {
  ...
  protected List<LinearVelocity> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_LinearVelocity_3, context.owl.prefixManager);
  ...
  protected String getErrorMessage(LinearVelocity linearVelocity) {
    return "LinearVelocity variable group '" + linearVelocity.getName().getId().toString() + "' contains variables with incompatible units";
  }
}
