...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_Volume_1;

public class VE_Volume_1 extends ValidationError<Volume> {
  @Override
  protected List<Volume> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_Volume_1, context.owl.prefixManager);
  ...
  protected String getErrorMessage(Volume volume) {
    return "Volume variable group '" + volume.getName().getId().toString() + "' contains variables with mixed causalities";
  }
}
