...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_LinearVelocity_2;

public class VE_LinearVelocity_2 extends ValidationError<LinearVelocity> {
  @Override
  protected List<LinearVelocity> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_LinearVelocity_2, context.owl.prefixManager);
  ...
  protected String getErrorMessage(LinearVelocity linearVelocity) {
    return "LinearVelocity variable group '" + linearVelocity.getName().getId().toString() + "' contains variables with mixed data types";
  }
}
