...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_VariableGroupConnection_3;

public class VE_VariableGroupConnection_3 extends ValidationError<VariableGroupConnection> {
  @Override
  protected List<VariableGroupConnection> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_VariableGroupConnection_3, context.owl.prefixManager);
  ...
  protected String getErrorMessage(VariableGroupConnection variableGroupConnection) {
    ...
    return "VariableGroupConnection [" + variableGroupA + ", " + variableGroupB + "] contains incompatible VariableGroups. " +
        "Resulting VariableConnections becomes invalid";
  }
}
