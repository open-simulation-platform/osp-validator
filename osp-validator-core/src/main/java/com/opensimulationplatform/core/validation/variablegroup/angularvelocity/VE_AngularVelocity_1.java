...
public class VE_AngularVelocity_1 extends ValidationError<AngularVelocity> {
  ...
  protected List<AngularVelocity> getInvalidObjects() {
    ...
    OWLClass validationErrorClass = config.dataFactory.getOWLClass(VE_AngularVelocity_1, config.prefixManager);
  ...
  protected String getErrorMessage(AngularVelocity angularVelocity) {
    return "AngularVelocity variable group '" + angularVelocity.getName().get() + "' contains variables with mixed causalities";
  }
}
