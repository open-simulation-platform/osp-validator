...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_Current_1;

public class VE_Current_1 extends ValidationError<Current> {
  @Override
  protected List<Current> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_Current_1, context.owl.prefixManager);
  ...
  protected String getErrorMessage(Current current) {
    return "Current variable group '" + current.getName().get() + "' contains variables with mixed causalities";
  }
}
