...
import static com.opensimulationplatform.gen.model.OntologyClasses.VE_LinearVelocity_1;
...
public class VE_LinearVelocity_1 extends ValidationError<LinearVelocity> {
  ...
  protected List<LinearVelocity> getInvalidObjects() {
    ...
    OWLClass validationErrorClass = config.dataFactory.getOWLClass(VE_LinearVelocity_1, config.prefixManager);
