...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_VolumeFlowRate_1;

public class VE_VolumeFlowRate_1 extends ValidationError<VolumeFlowRate> {
  @Override
  protected List<VolumeFlowRate> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_VolumeFlowRate_1, context.owl.prefixManager);
  ...
  protected String getErrorMessage(VolumeFlowRate volumeFlowRate) {
    return "VolumeFlowRate variable group '" + volumeFlowRate.getName().getId().toString() + "' contains variables with mixed causalities";
  }
}
