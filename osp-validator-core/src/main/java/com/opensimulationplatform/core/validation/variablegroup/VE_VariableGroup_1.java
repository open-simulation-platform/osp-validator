...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_VariableGroup_1;

public class VE_VariableGroup_1 extends ValidationError<VariableGroup> {
  @Override
