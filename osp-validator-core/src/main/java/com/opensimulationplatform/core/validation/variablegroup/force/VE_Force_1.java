...
import static com.opensimulationplatform.gen.owl.model.OntologyClasses.VE_Force_1;

public class VE_Force_1 extends ValidationError<Force> {
  @Override
  protected List<Force> getInvalidObjects() {
    OWLClass validationErrorClass = context.owl.dataFactory.getOWLClass(VE_Force_1, context.owl.prefixManager);
  ...
  protected String getErrorMessage(Force force) {
    return "Force variable group '" + force.getName().getId().toString() + "' contains variables with mixed causalities";
  }
}
