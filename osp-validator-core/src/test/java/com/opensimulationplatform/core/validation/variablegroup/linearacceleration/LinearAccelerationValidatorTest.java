...
public class LinearAccelerationValidatorTest {
  @Test
  public void valid() {
    ...
    modelDescription.getLinearAccelerations().add(linearAcceleration);

    LinearAccelerationValidator v = new LinearAccelerationValidator();
    List<ValidationDiagnostic<LinearAcceleration>> diagnostics = v.validate(modelDescription);
  ...
  public void invalid() {
    ...
    for (ValidationDiagnostic<LinearAcceleration> diagnostic : diagnostics) {
      assertEquals(linearAcceleration, diagnostic.getValidatedObject());
    }
  }
}
