...
public class VE_Torque_2_Test {

  private final VE_Torque_2 validationError = new VE_Torque_2();
  ...
  public void valid() {
    ...
    builder.build(torque);
    builder.complete();

    List<ValidationDiagnostic<Torque>> diagnostics = validationError.validate();
