...
public class VE_LinearVelocity_3_Test {

  private final VE_LinearVelocity_3 validationError = new VE_LinearVelocity_3();
  ...
  public void valid() {
    ...
    builder.build(linearVelocity);
    builder.complete();

    List<ValidationDiagnostic<LinearVelocity>> diagnostics = validationError.validate();
  ...
  public void invalid() {
    ...
    LinearVelocity invalidObject = diagnostics.get(0).getValidatedObject();
