...
public class OntologyObjectProperties {
  ...
  public static final String op_has_base_unit = "op_has_base_unit";
  public static final String op_has_exponent_mole = "op_has_exponent_mole";
  ...
  public static final String op_has_variable = "op_has_variable";
  public static final String op_has_simulator = "op_has_simulator";
  public static final String op_has_exponent_radian = "op_has_exponent_radian";
  public static final String op_has_name = "op_has_name";
  public static final String op_has_rhs = "op_has_rhs";
  public static final String op_has_variable_group_type = "op_has_variable_group_type";
  public static final String op_has_exponent_second = "op_has_exponent_second";
  public static final String op_has_exponent_ampere = "op_has_exponent_ampere";
