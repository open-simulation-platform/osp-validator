 ...
 *       &lt;sequence>
 *         &lt;element name="NmeaTrueHeading" type="{https://open-simulation-platform.com/OspModelDescription/1.0.1}NmeaTrueHeadingType"/>
...
@XmlType(name = "NmeaThsType", propOrder = {
    "nmeaTrueHeading",
    "nmeaStatus"
})
public class NmeaThsType {

    @XmlElement(name = "NmeaTrueHeading", required = true)
