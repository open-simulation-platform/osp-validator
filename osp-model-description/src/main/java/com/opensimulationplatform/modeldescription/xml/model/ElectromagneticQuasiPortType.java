 ...
 *         &lt;element name="Charge" type="{http://opensimulationplatform.com/osp-is/OSPModelDescription}ChargeType"/>
 *       &lt;/sequence>
...
@XmlType(name = "ElectromagneticQuasiPortType", namespace = "http://opensimulationplatform.com/osp-is/OSPModelDescription", propOrder = {
    "voltage",
    "charge"
})
public class ElectromagneticQuasiPortType {
    ...
    @XmlElement(name = "Charge", namespace = "http://opensimulationplatform.com/osp-is/OSPModelDescription", required = true)
