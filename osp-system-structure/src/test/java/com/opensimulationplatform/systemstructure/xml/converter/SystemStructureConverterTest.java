...
public class SystemStructureConverterTest {
  ...
  public void canConvert() {
    ...
    List<OspSimulator> ospSimulators = systemStructure.getOspSimulators();
    ...
    for (Simulators.Simulator simulator : simulatorList) {
      assertEquals(simulator.getName(), systemStructure.getSimulatorByName(simulator.getName()).getName());
    }
